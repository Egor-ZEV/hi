root@cf649877b739:/etc/freeradius/mods-enabled# ldapsearch -x -H ldap://172.28.0.5:389 -b dc=ldap,dc=server,dc=rlik -D "cn=admin,dc=ldap,dc=server,dc=rlik" -w admin
# extended LDIF
#
# LDAPv3
